...
# class ZojAdminSite(AdminSite):
    # Text to put at the end of each page's <title>.
    # site_title = ugettext_lazy('My site admin')

    # Text to put in each page's <h1> (and above login form).
    # site_header = 'Администрирование сайта ZOJ.NEWS'

#
# admin_site = ZojAdminSite()
admin.site.site_header = 'Администрирование сайта ZOJ.NEWS'
